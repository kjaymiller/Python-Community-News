...
"""
    with pytest.raises(ValueError):
        issues.get_content_issues(bad_issue, "Issue")


def test_valid_issue_returns_issue_list(issue_text):
    assert list(issues.get_content_issues(issue_text, "Issues")) == ["1", "2", "3", "4"]
